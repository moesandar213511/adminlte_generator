...
class PostDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'photo' =>[ 'photo', 'data' => 'photo', 'render' => '"<img src=\"upload/post/"+data+"\" width=\"100\" height=\"100\"/>"'],
            'cat_id' => new \Yajra\DataTables\Html\Column(['title' => 'Cat Name', 'data' => 'category.name', 'name' => 'category.name']),
